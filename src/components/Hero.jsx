...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 xl:pl-16`}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt, quas eligendi? Laboriosam perspiciatis magni quisquam at temporibus aliquid rerum. Facere nesciunt illum sed laborum numquam dicta nemo labore quis maxime?</p>
    </div>
